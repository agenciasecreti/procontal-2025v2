...
export function generateSEOMetadata(meta: PageMetadata): Metadata {
  return {
        ...
        ? [
            {
              ...
              width: 1200,
              height: 630,
              alt: meta.title || process.env.NEXT_PUBLIC_SITE_TITLE,
            },
          ]
        : undefined,
    },
    ...
    authors: [{ name: process.env.NEXT_PUBLIC_SITE_TITLE }],
    creator: process.env.NEXT_PUBLIC_SITE_TITLE,
    publisher: process.env.NEXT_PUBLIC_SITE_TITLE,
